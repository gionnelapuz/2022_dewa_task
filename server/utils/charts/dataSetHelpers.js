async function getDataSetsFromObjectOrArray(data) {
  try {
...
async function getDataSetFromObject(object) {
  let dataSets = [];
...
async function getHeaders(array) {
  if (array.length > 0) {
    return Object.keys(array[0]);
  }
};

async function getDataSetFromArray(array) {
  let dataSet = [];
  if (array.length > 0) {
...
async function formatDataSetObject(object) {
  for (const key in object) {
...
async function retrieveDataSet(dataSet, key) {
...
async function generateChartData (dataSet, keys) {
